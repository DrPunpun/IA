...
print(z.list_instance_type())
print(z.list_names())
print(z.list_types())
print(z.list_ent_assoc('socrates'))
print(z.list_ent_relation('homem'))
print(z.list_num_assoc('descartes'))
print(z.list_tup_assoc('homem'))
print(z.check_predec('vertebrado', 'socrates'))
print(z.check_predec('vertebrado', 'filosofo'))
print(z.predecessor_path('vertebrado', 'socrates'))
print(z.query('socrates', 'altura'))
print(z.query2('homem', 'mamar'))
print(z.query2('homem'))
